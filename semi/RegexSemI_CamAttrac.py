"""
RegexSemI_CamAttrac.py - regular expression based CamAttrac SemI decoder
=========================================================================
...
class RegexSemI_CamAttrac(RegexSemI.RegexParser):
    """
    """
    def __init__(self, repoIn=None):
        RegexSemI.RegexParser.__init__(self, repoIn)  #better than super() here - wont need to be changed for other domains
        self.domainTag = "CamAttrac"  #FIXME
    ...
    def create_domain_dependent_regex(self):
        ...
        for slot in self.slot_values.keys():
            self.slot_values[slot] = {value:"("+str(value)+")" for value in domain_util.ontology["informable"][slot]}
