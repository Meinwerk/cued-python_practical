...
def run_on_grid(targetDir, execDir, configName, text):
    ...
    command = 'python run_grid_testing.py ' + targetDir + ' TEST 10 100 1 ' + execDir + ' 15 1 ' + config
    os.system(command)
...
def main():
	...
	################################################
        ...
        #kernel_theta_pair = kernel_theta_pair[:5]
        kernel_theta_pair = kernel_theta_pair[5:10]
