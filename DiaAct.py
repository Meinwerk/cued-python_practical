...
'''
DiaAct.py - dialogue act specification
=========================================
...
.. note::
    ...
    This extends the preexisting dact.py from dstcii
...
class DiaAct(object):
    ...
    def get_value(self, slot, negate=False):
        '''
        :param slot: (str) slot name
        :param negate: (bool - default False) relating to semantic operation, i.e slot = or slot !=.
        :returns: (str) value
        '''
        value = None
        for item in self.items:
    ...
    def get_values(self, slot, negate=False):
        '''
        :param slot: (str) slot name
        :param negate: (bool - default False) - semantic operation
    ...
    def has_conflicting_value(self, constraints):
        '''
        :param constraints: (list) as  [(slot, op, value), ...]
    ...
    def getDiaItemFormat(self):
        '''
        :param None: (based on self.items)
